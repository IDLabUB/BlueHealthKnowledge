...
COG_F_NAME = 'counts_blue_health_activities.p'   # File name for the blue-health activity counts object
...
def main():
    ...
    cog_counts = load_object(COG_F_NAME, directory=str(COUNTS_DIR))
